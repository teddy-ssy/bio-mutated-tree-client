...
public class AzureUtilNew {
    ...
    public static String Uploadfasta(InputStream image, int imageLength, String name,String containe) throws Exception {
        CloudBlobContainer container = getContainer(containe);
    ...
    public static String Uploadfasta(File file, String name,String containe) throws Exception {
        CloudBlobContainer container = getContainer(containe);
    ...
    public static String[] Listallfile(String containe) throws Exception{
        CloudBlobContainer container = getContainer(containe);
    ...
    public static String[] ListallfilePath(String containe) throws Exception{
        CloudBlobContainer container = getContainer(containe);
    ...
    public static void GetFile(String name, OutputStream imageStream, long imageLength,String containe) throws Exception {
        CloudBlobContainer container = getContainer(containe);
