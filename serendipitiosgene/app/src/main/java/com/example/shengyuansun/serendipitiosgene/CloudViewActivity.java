...
public class CloudViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_cloud_view);

        DB = new DatabaseHelper(this);
        ReadFromSDCard.Checkfilebypath(Constatns.filedirct);

        button_cloud =(Button)findViewById(R.id.button_cloud);
        ...
        button_cloud.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String contairer = edit_text_cloud.getText().toString();
                Thread th = new Thread(new Runnable() {
                    public void run() {

                        try {

                            final String[] files = AzureUtilNew.Listallfile(contairer);
                            final String[] paths = AzureUtilNew.ListallfilePath(contairer);
